...
# source: contrib/control/clock.proto
...
CalendarMetadata = _reflection.GeneratedProtocolMessageType('CalendarMetadata', (_message.Message,), dict(
  ...
  __module__ = 'contrib.control.clock_pb2'
