...
from contrib.control.clock import sim_engine as sim
...
class MinuteSimulationLoop(object):
    def __init__(self, start_dt, end_dt, capital, max_leverage):
        self._clocks = clocks = {}
        # create fake clock
        ...
        self._control_mode = simulation_mode.SimulationControlMode(capital, max_leverage)
