...
class SimulationClockRouterStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Register = channel.unary_unary(
        ...
        request_serializer=contrib_dot_control_dot_clock__pb2.SimulationClockParameters.SerializeToString,
        response_deserializer=contrib_dot_control_dot_clock__pb2.Attributes.FromString,
        )
    self.Run = channel.unary_unary(
        '/SimulationClockRouter/Run',
        request_serializer=contrib_dot_control_dot_clock__pb2.SimulationRunParameters.SerializeToString,
...
def add_SimulationClockRouterServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Register': grpc.unary_unary_rpc_method_handler(
          servicer.Register,
          request_deserializer=contrib_dot_control_dot_clock__pb2.SimulationClockParameters.FromString,
          response_serializer=contrib_dot_control_dot_clock__pb2.Attributes.SerializeToString,
      ),
      'Run': grpc.unary_unary_rpc_method_handler(
          servicer.Run,
          request_deserializer=contrib_dot_control_dot_clock__pb2.SimulationRunParameters.FromString,
...
class RealtimeClockRouterStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Register = channel.unary_unary(
        ...
        request_serializer=contrib_dot_control_dot_clock__pb2.RealtimeClockParameters.SerializeToString,
        response_deserializer=contrib_dot_control_dot_clock__pb2.Attributes.FromString,
        )
...
def add_RealtimeClockRouterServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Register': grpc.unary_unary_rpc_method_handler(
          servicer.Register,
          request_deserializer=contrib_dot_control_dot_clock__pb2.RealtimeClockParameters.FromString,
          response_serializer=contrib_dot_control_dot_clock__pb2.Attributes.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
...
class SimulationClockStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetState = channel.unary_unary(
        ...
        request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
        response_deserializer=contrib_dot_control_dot_clock__pb2.State.FromString,
        )
...
def add_SimulationClockServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetState': grpc.unary_unary_rpc_method_handler(
          servicer.GetState,
          request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
          response_serializer=contrib_dot_control_dot_clock__pb2.State.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
