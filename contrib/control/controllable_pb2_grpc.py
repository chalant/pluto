...
class ControllableStub(object):
  ...
  def __init__(self, channel):
    ...
    self.UpdateParameters = channel.unary_unary(
        ...
        request_serializer=contrib_dot_control_dot_controller__pb2.ParametersUpdateMessage.SerializeToString,
        response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
        )
    ...
    self.Update = channel.stream_stream(
        '/Controllable/Update',
        request_serializer=contrib_dot_control_dot_data__pb2.Data.SerializeToString,
        response_deserializer=contrib_dot_control_dot_data__pb2.Data.FromString,
        )
...
def add_ControllableServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'UpdateParameters': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=contrib_dot_control_dot_controller__pb2.ParametersUpdateMessage.FromString,
          response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ),
      ...
      'Update': grpc.stream_stream_rpc_method_handler(
          servicer.Update,
          request_deserializer=contrib_dot_control_dot_data__pb2.Data.FromString,
          response_serializer=contrib_dot_control_dot_data__pb2.Data.SerializeToString,
      ),
