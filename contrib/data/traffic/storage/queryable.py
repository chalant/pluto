...
class Bars(ABC):
	...
	def get_bars(self, symbol:str,calendar:TradingCalendar) -> DataFrame:
...
class SymbolMetaData(ABC):
	'''should be the 'central' point for maintaining cohesion between anything related
	with equities'''
