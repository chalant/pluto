...
# source: contrib/coms/protos/account_service.proto
...
WarningMessage = _reflection.GeneratedProtocolMessageType('WarningMessage', (_message.Message,), dict(
  ...
  __module__ = 'contrib.coms.protos.account_service_pb2'
...
_CLIENTACCOUNT = _descriptor.ServiceDescriptor(
  name='ClientAccount',
  full_name='ClientAccount',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='SingleOrder',
    full_name='ClientAccount.SingleOrder',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='AccountState',
    full_name='ClientAccount.AccountState',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='PortfolioState',
    full_name='ClientAccount.PortfolioState',
    index=2,
    containing_service=None,
    input_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
  ...
  _descriptor.MethodDescriptor(
    name='PositionsState',
    full_name='ClientAccount.PositionsState',
    index=3,
    containing_service=None,
    input_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
  ...
  _descriptor.MethodDescriptor(
    name='Orders',
    full_name='ClientAccount.Orders',
    index=4,
    containing_service=None,
    input_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    output_type=contrib_dot_coms_dot_protos_dot_protocol__pb2._ORDER,
  ...
  _descriptor.MethodDescriptor(
    name='Transactions',
    full_name='ClientAccount.Transactions',
    index=5,
    containing_service=None,
    input_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
  ...
  _descriptor.MethodDescriptor(
    name='BatchOrder',
    full_name='ClientAccount.BatchOrder',
    index=6,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='CancelOrder',
    full_name='ClientAccount.CancelOrder',
    index=7,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='ClientAccount.CancelAllOrdersForAsset',
    index=8,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetDataBundle',
    full_name='ClientAccount.GetDataBundle',
    index=9,
    containing_service=None,
...
_sym_db.RegisterServiceDescriptor(_CLIENTACCOUNT)

DESCRIPTOR.services_by_name['ClientAccount'] = _CLIENTACCOUNT
