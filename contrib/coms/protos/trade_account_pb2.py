...
# source: contrib/coms/protos/trade_account.proto
...
WarningMessage = _reflection.GeneratedProtocolMessageType('WarningMessage', (_message.Message,), dict(
  ...
  __module__ = 'contrib.coms.protos.trade_account_pb2'
...
_TRADEACCOUNT = _descriptor.ServiceDescriptor(
  name='TradeAccount',
  full_name='TradeAccount',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='SingleOrder',
    full_name='TradeAccount.SingleOrder',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='AccountState',
    full_name='TradeAccount.AccountState',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='PortfolioState',
    full_name='TradeAccount.PortfolioState',
    index=2,
    containing_service=None,
    input_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
  ...
  _descriptor.MethodDescriptor(
    name='PositionsState',
    full_name='TradeAccount.PositionsState',
    index=3,
    containing_service=None,
    input_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
  ...
  _descriptor.MethodDescriptor(
    name='Transactions',
    full_name='TradeAccount.Transactions',
    index=5,
    containing_service=None,
    input_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
  ...
  _descriptor.MethodDescriptor(
    name='BatchOrder',
    full_name='TradeAccount.BatchOrder',
    index=6,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='CancelOrder',
    full_name='TradeAccount.CancelOrder',
    index=7,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='TradeAccount.CancelAllOrdersForAsset',
    index=8,
    containing_service=None,
...
_sym_db.RegisterServiceDescriptor(_TRADEACCOUNT)

DESCRIPTOR.services_by_name['TradeAccount'] = _TRADEACCOUNT
