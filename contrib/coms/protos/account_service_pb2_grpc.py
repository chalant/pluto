...
from contrib.coms.protos import account_service_pb2 as contrib_dot_coms_dot_protos_dot_account__service__pb2
...
class ClientAccountStub(object):
  ...
  def __init__(self, channel):
    ...
    self.SingleOrder = channel.unary_unary(
        '/ClientAccount/SingleOrder',
        request_serializer=contrib_dot_coms_dot_protos_dot_account__service__pb2.OrderParams.SerializeToString,
    ...
    self.BatchOrder = channel.stream_stream(
        '/ClientAccount/BatchOrder',
        request_serializer=contrib_dot_coms_dot_protos_dot_account__service__pb2.BatchOrderParams.SerializeToString,
        response_deserializer=contrib_dot_coms_dot_protos_dot_protocol__pb2.Order.FromString,
        )
    self.CancelOrder = channel.unary_unary(
        '/ClientAccount/CancelOrder',
    ...
    self.CancelAllOrdersForAsset = channel.unary_unary(
        '/ClientAccount/CancelAllOrdersForAsset',
        request_serializer=contrib_dot_coms_dot_protos_dot_assets__pb2.Asset.SerializeToString,
        response_deserializer=contrib_dot_coms_dot_protos_dot_account__service__pb2.WarningMessage.FromString,
        )
    self.GetDataBundle = channel.unary_stream(
        '/ClientAccount/GetDataBundle',
...
def add_ClientAccountServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'SingleOrder': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=contrib_dot_coms_dot_protos_dot_account__service__pb2.OrderParams.FromString,
      ...
      'BatchOrder': grpc.stream_stream_rpc_method_handler(
          servicer.BatchOrder,
          request_deserializer=contrib_dot_coms_dot_protos_dot_account__service__pb2.BatchOrderParams.FromString,
          response_serializer=contrib_dot_coms_dot_protos_dot_protocol__pb2.Order.SerializeToString,
      ),
      ...
      'CancelAllOrdersForAsset': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=contrib_dot_coms_dot_protos_dot_account__service__pb2.WarningMessage.SerializeToString,
      ),
