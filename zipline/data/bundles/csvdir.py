...
def csvdir_equities(tframes=None, csvdir=None, exchange=None):
	"""
	...
	return CSVDIRBundle(tframes, csvdir, exchange).ingest
...
class CSVDIRBundle:
	...
	def __init__(self, tframes=None, csvdir=None, exchange=None):
