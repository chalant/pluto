...
_PORTFOLIO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stating_cash', full_name='Portfolio.stating_cash', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='position', full_name='Portfolio.position', index=6,
...
_POSITION.fields_by_name['asset'].message_type = contrib_dot_coms_dot_protos_dot_assets__pb2._ASSET
_POSITION.fields_by_name['last_sale_date'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_PORTFOLIO.fields_by_name['position'].message_type = _ASSETPOSITIONPAIR
_PORTFOLIO.fields_by_name['start_date'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_ASSETPOSITIONPAIR.fields_by_name['key'].message_type = contrib_dot_coms_dot_protos_dot_assets__pb2._ASSET
