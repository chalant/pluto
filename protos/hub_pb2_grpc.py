...
class HubStub(object):
  ...
  def __init__(self, channel):
    ...
    self.DeploymentStatus = channel.unary_stream(
        ...
        request_serializer=protos_dot_hub__pb2.DeploymentStatusRequest.SerializeToString,
    ...
    self.List = channel.unary_stream(
        '/Hub/List',
        request_serializer=protos_dot_hub__pb2.ListRequest.SerializeToString,
        response_deserializer=protos_dot_data__pb2.Data.FromString,
        )
...
def add_HubServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'DeploymentStatus': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=protos_dot_hub__pb2.DeploymentStatusRequest.FromString,
      ...
      'List': grpc.unary_stream_rpc_method_handler(
          servicer.List,
          request_deserializer=protos_dot_hub__pb2.ListRequest.FromString,
          response_serializer=protos_dot_data__pb2.Data.SerializeToString,
      ),
  }
